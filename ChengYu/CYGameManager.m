...
//        //测试数据
//        [self addNewWord:@"望,子,成,龙" needLock:NO];
//        [self addNewWord:@"坐,井,观,天" needLock:YES];
//        [self addNewWord:@"刻,舟,求,剑" needLock:NO];
//        [self addNewWord:@"乘,龙,快,婿" needLock:YES];
//        [self addNewWord:@"川,流,不,息" needLock:NO];
//        [self addNewWord:@"车,水,马,龙" needLock:NO];
//        [self addNewWord:@"不,伦,不,类" needLock:NO];
//        [self addNewWord:@"不,三,不,四" needLock:YES];
//        [self addNewWord:@"疾,风,劲,草" needLock:NO];
